...
function TestComponent() {
  const { admin, isLoading, authStep, qrCode, error, loginStep1, loginStep2, logout, clearError } =
    useAdminAuth();
  ...
  return (
    <div>
      ...
      <button onClick={() => handleLoginStep1("wrong@example.com", "wrong")}>Login Invalid</button>
