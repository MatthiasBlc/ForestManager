...
describe("IngredientList", () => {
  ...
  it("should render add ingredient button", () => {
    render(<IngredientList value={[]} onChange={mockOnChange} />);
  ...
  it("should update ingredient name", async () => {
    const user = userEvent.setup();
    const ingredients: IngredientInput[] = [{ name: "sugar", quantity: 100 }];
  ...
  it("should update ingredient quantity as a number", async () => {
    ...
    const ingredients: IngredientInput[] = [{ name: "sugar" }];
  ...
  it("should remove ingredient when remove button is clicked", async () => {
    ...
    expect(mockOnChange).toHaveBeenCalledWith([{ name: "flour", quantity: 200 }]);
  });

  it("should render placeholder text for empty inputs", () => {
    const ingredients: IngredientInput[] = [{ name: "" }];
