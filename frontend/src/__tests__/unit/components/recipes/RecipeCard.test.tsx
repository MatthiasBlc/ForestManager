...
describe("RecipeCard", () => {
  ...
  it('should show "No image" when imageUrl is null', () => {
    ...
    render(<RecipeCard recipe={recipeWithoutImage} onDelete={mockOnDelete} />);
  ...
  it("should call onTagClick when clicking a tag", async () => {
    ...
    render(<RecipeCard recipe={mockRecipe} onDelete={mockOnDelete} onTagClick={mockOnTagClick} />);
  ...
  it("should call onDelete when delete button is clicked and confirmed", async () => {
    ...
    const deleteButton = deleteButtons.find((btn) => btn.classList.contains("text-error"));
  ...
  it("should display updated date when recipe was updated", () => {
    ...
    render(<RecipeCard recipe={updatedRecipe} onDelete={mockOnDelete} />);
  ...
  it("should not display time badge when all times are null", () => {
    ...
    render(<RecipeCard recipe={recipeNoTimes} onDelete={mockOnDelete} />);
  ...
  it("should render pending tags with warning style via TagBadge", () => {
    ...
    render(<RecipeCard recipe={recipeWithPending} onDelete={mockOnDelete} />);
