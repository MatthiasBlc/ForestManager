...
describe("ServingsSelector", () => {
  it("should render with current value", () => {
    render(<ServingsSelector value={4} onChange={vi.fn()} />);
  ...
  it("should increment value on + click", async () => {
    ...
    render(<ServingsSelector value={4} onChange={onChange} />);
  ...
  it("should disable - button when value is 1", () => {
    render(<ServingsSelector value={1} onChange={vi.fn()} />);
    expect(screen.getByText("-")).toBeDisabled();
  });

  it("should disable + button when value is 100", () => {
    render(<ServingsSelector value={100} onChange={vi.fn()} />);
    expect(screen.getByText("+")).toBeDisabled();
  });
