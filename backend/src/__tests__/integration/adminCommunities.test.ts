...
describe("Admin Communities API", () => {
  ...
  describe("GET /api/admin/communities", () => {
    it("should return all communities with counts", async () => {
      ...
      const res = await request(app).get("/api/admin/communities").set("Cookie", adminCookie);
      ...
      const community = res.body.communities.find(
        (c: { name: string }) => c.name === "Community A"
      );
  ...
  describe("GET /api/admin/communities/:id", () => {
    ...
    it("should return 404 for non-existent community", async () => {
      const res = await request(app)
        .get("/api/admin/communities/00000000-0000-4000-8000-000000000000")
        .set("Cookie", adminCookie);
  ...
  describe("PATCH /api/admin/communities/:id", () => {
    ...
    it("should return 404 for non-existent community", async () => {
      const res = await request(app)
        .patch("/api/admin/communities/00000000-0000-4000-8000-000000000000")
        .set("Cookie", adminCookie)
        .send({ name: "New Name" });
  ...
  describe("DELETE /api/admin/communities/:id", () => {
    ...
    it("should return 404 for non-existent community", async () => {
      const res = await request(app)
        .delete("/api/admin/communities/00000000-0000-4000-8000-000000000000")
        .set("Cookie", adminCookie);
