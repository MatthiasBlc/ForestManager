...
afterEach(async () => {
  ...
  await testPrisma.$transaction([
    ...
    testPrisma.notificationPreference.deleteMany(),
    ...
    testPrisma.tagSuggestion.deleteMany(),
    testPrisma.mealSlotPin.deleteMany(),
    testPrisma.mealGenerationRule.deleteMany(),
    testPrisma.mealSlotExclusion.deleteMany(),
    testPrisma.mealGenerationParams.deleteMany(),
    testPrisma.mealSlot.deleteMany(),
    testPrisma.mealPlan.deleteMany(),
    testPrisma.mealIdea.deleteMany(),
    ...
    testPrisma.userCommunityTagPreference.deleteMany(),
